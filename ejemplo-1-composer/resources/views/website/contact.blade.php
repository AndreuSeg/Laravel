...
<body>
    <header>
        <nav>
            ...
            <a @if ($section == 'contact') style="color: grey" @endif href="{{ route('website.section', ['section' => 'contact']) }}">Contacto</a><br>
        </nav>
    </header>
    ...
    <form action="{{ route('website.sendContact') }}" method="POST">
        ...
        <p><textarea name="message" cols="30" rows="10" placeholder="Mensaje"></textarea></p>
